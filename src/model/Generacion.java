				...
				if(numOmitido != j) {
					switch(j) {
						case 0:
							...
							robotsElegidos[i].getCaracteristicas().Bateria = 
									robotsElegidos[i+1].getCaracteristicas().Bateria;
							robotsElegidos[i+1].getCaracteristicas().Bateria = bateria;
							break;
						case 1:
							Hardware motor = robotsElegidos[i].getCaracteristicas().Motor;
							robotsElegidos[i].getCaracteristicas().Motor = 
									robotsElegidos[i+1].getCaracteristicas().Motor;
							robotsElegidos[i+1].getCaracteristicas().Motor = motor;
							break;
						case 2:
							Hardware camara = robotsElegidos[i].getCaracteristicas().Camara;
							robotsElegidos[i].getCaracteristicas().Camara = 
									robotsElegidos[i+1].getCaracteristicas().Camara;
